...
export function LessonCard(lesson) {
    return (
      <li className='shrink-1 group flex items-center justify-between rounded-lg px-2 transition ease-in-out hover:bg-gray-100  hover:transition-colors dark:hover:bg-gray-700'>
...
export default function CourseTOC({ lessons, course, overview }) {
    ...
    return(
        <div>
            <div className='mb-6'>
                <a href="#top">
                    <h1 className='mx-auto mt-4 text-center text-3xl font-bold'> {course} </h1>
                </a>
            </div>
            <div className='mb-6'>
                <h2 className="mb-1 text-lg font-medium text-slate-600">
                    Overview
                </h2>
                <p className='prose max-w-none text-slate-400'>
                    {overview}
                </p>
            </div>


            <div className="dark:border-gray-700' bg-white mb-10 rounded-lg shadow dark:bg-gray-800">
