...
export function HeadingItem({ heading }){
  ...
  return(
    <li key={heading.text} className={cn("font-Poppins hover:text-[#bb434e] hover:underline hover:underline-offset-4 my-1.5 list-disc", classAddition)}>
...
export default function HeadingToc({headings}) {
    return (
        <div className="font-Poppins fixed hidden lg:block right-[70px] 2xl:right-[200px] 2xl:w-[350px] w-[300px] h-full mt-5">
