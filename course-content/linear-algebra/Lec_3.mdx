...
[**_Infinite Solutions_**](https://www.geogebra.org/3d/fa3q4bst)
    ...
    - This is typically denoted with the following type of **_RREF_**:
...
## Application: Chemical Engineering Problem
(solving a CHE208 problem on the quicks)
