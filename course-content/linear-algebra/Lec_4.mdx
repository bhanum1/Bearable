...
A matrix is considered invertable if it meets the following conditions:
...
To put it briefly, inverses are vital because this gives us a vital tool we need in our kit to dive into the second half of linear algebra (which we still won't do yet because there are some loose ends to tie up.)
