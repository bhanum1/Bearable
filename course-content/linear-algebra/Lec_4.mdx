...
(Note you can kind of make injective functions invertible by just redefining the output space to ignore the area the function doesn't map to, but we don't believe this is too important to understand for now.)
## Surjective
...
$$
\textrm{Find a linear combination of }
